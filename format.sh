...
if [ "$operation" == "run" ]; then
    ...
    find "$REPO_ROOT_DIR/include/ctz" "$REPO_ROOT_DIR/src" "$REPO_ROOT_DIR/example" "$REPO_ROOT_DIR/test" -type f \( -name "*.cpp" -or -name "*.c" -or -name "*.h" -or -name "*.hpp" \) -exec clang-format -i --style=file '{}' \;
    ...
    files=$(find "$REPO_ROOT_DIR/include/ctz" "$REPO_ROOT_DIR/src" "$REPO_ROOT_DIR/example" "$REPO_ROOT_DIR/test" -name "*.cpp" -or -name "*.c" -or -name "*.h" -or -name "*.hpp")
